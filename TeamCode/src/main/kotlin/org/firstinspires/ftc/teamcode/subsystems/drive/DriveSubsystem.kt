...
object DriveSubsystem : SubsystemBase() {
    ...
    class DriveLocalizer : Localizer {
        ...
        private var lastHeading: Rotation2d = Rotation2d.exp(imu.robotYawPitchRollAngles.getYaw(AngleUnit.RADIANS))
...
//        }
    ...
    class FollowTrajectoryAction(val timeTrajectory: TimeTrajectory) : Action {
